...
medusa_benchmark_dir='/home/shahrzad/repos/Blazemark/data/grain_size_benchmarks/1/'
gf.create_dict_benchmark([medusa_benchmark_dir])
...
for ps in problem_sizes:
    ...
    for th in thr:
        ...
        plt.scatter(array_t[:,5],array_t[:,-1],label='true')   

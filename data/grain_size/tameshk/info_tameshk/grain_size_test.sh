...
if [ $# -ne 1 ]
then
echo "node not specified, tameshk by default"
node="tameshk"
else
node=$1
...
blazemark_dir="$HOME/blazemark"
hpx_dir="$HOME/src/hpx/build_release_clang_no_hpxmp_${node}/lib"
hpx_bin_dir="$HOME/src/hpx/build_release_clang_no_hpxmp_${node}/bin"
hpx_source_dir="$HOME/src/hpx"
hpx_log_dir="$HOME/src/hpx/build_release_clang_no_hpxmp_${node}/info/"
results_dir="${blazemark_dir}/results_grain_size"
export LD_LIBRARY_PATH=${hpx_dir}:$LD_LIBRARY_PATH
#/opt/boost/1.68.0-clang6.0.1/release/lib:$LD_LIBRARY_PATH
...
cp $HOME/lib/hpx/hpx_release_clang_no_hpxmp_${node}/include/hpx/parallel/util/detail/chunk_size.hpp ${results_dir}/info_${node}/hpx_info/

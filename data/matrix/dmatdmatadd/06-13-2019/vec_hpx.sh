...
export LD_LIBRARY_PATH=${hpx_dir}:/opt/boost/1.68.0-clang6.0.0/release/lib:$LD_LIBRARY_PATH
thr=(16)
...
cp ${blazemark_dir}/scripts/vec_hpx.sh ${results_dir}/info/

...
date_str='10-16-18-1807'
from matplotlib.backends.backend_pdf import PdfPages

directory='/home/shahrzad/Spyder/Blazemark/results/data/dynamic'+date_str
...
#            print(benchmark, cores, runtime)
        ...
        (benchmark, cores, runtime, chunk_size,size) = filename.split('/')[-1].replace('.dat','').split('-')

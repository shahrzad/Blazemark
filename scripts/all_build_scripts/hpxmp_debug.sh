...
cmake -DCMAKE_BUILD_TYPE='Debug' -DHPXMP_WITH_TRACE=ON -DCMAKE_C_COMPILER=/opt/mn/clang/6.0.1/bin/clang -DCMAKE_CXX_COMPILER=/opt/mn/clang/6.0.1/bin/clang++ -DCMAKE_CXX_FLAGS=-stdlib=libc++ -DHPX_DIR=$hpx_dir ..| tee hpxmp_cmake_log.txt
make -j 16

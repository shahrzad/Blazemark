...
CXX_FLAGS="-DHPX_WITH_THREAD_IDLE_RATES=ON -DHPX_WITH_THREAD_LOCAL_STORAGE=ON -DHPX_WITH_DYNAMIC_HPX_MAIN=OFF -DHPX_WITH_THREAD_MANAGER_IDLE_BACKOFF=ON"
...
then
	...
	then
		...
		build_dir="${build_dir}_clang_idle"
                install_dir="${install_dir}_clang_idle"

...
cp $repo_dir/scripts/hpxmp_log_idle.sh ${results_dir}/info/
...
LD_PRELOAD=/home/sshirzad/src/hpxMP/build_release_idle/libhpxmp.so ${benchmarks_dir}/${b}_${r} -only-blaze>>${results_dir}/${i}-${b}-${th}-hpxmp.dat

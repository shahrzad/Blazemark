...
export HPX_COMMANDLINE_OPTIONS="hpx:queuing=static-priority"
LD_PRELOAD=/home/sshirzad/src/hpxMP/build_release/libhpxmp.so ${benchmarks_dir}/${b}_${r} -only-blaze>>${results_dir}/test/${i}-${b}-${th}-hpxmp.dat
